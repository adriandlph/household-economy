...
public enum Permission {
    ...
    ADD_BANK_ACCOUNT(PermissionGroup.SYSTEM_FINANCIAL_PERMISSIONS),
    GET_BANK_ACCOUNT(PermissionGroup.SYSTEM_FINANCIAL_PERMISSIONS),
    DELETE_BANK_ACCOUNT(PermissionGroup.SYSTEM_FINANCIAL_PERMISSIONS),
    EDIT_BANK_ACCOUNT(PermissionGroup.SYSTEM_FINANCIAL_PERMISSIONS),

    ADD_BANK_ACCOUNT_OWNER(PermissionGroup.SYSTEM_FINANCIAL_PERMISSIONS),
    REMOVE_BANK_ACCOUNT_OWNER(PermissionGroup.SYSTEM_FINANCIAL_PERMISSIONS),

    CREATE_CREDIT_CARD(PermissionGroup.SYSTEM_FINANCIAL_PERMISSIONS),
    GET_CREDIT_CARD(PermissionGroup.SYSTEM_FINANCIAL_PERMISSIONS),
    DELETE_CREDIT_CARD(PermissionGroup.SYSTEM_FINANCIAL_PERMISSIONS),
    EDIT_CREDIT_CARD(PermissionGroup.SYSTEM_FINANCIAL_PERMISSIONS),

    CREATE_DEBIT_CARD(PermissionGroup.SYSTEM_FINANCIAL_PERMISSIONS),
    GET_DEBIT_CARD(PermissionGroup.SYSTEM_FINANCIAL_PERMISSIONS),
    DELETE_DEBIT_CARD(PermissionGroup.SYSTEM_FINANCIAL_PERMISSIONS),
    EDIT_DEBIT_CARD(PermissionGroup.SYSTEM_FINANCIAL_PERMISSIONS),
